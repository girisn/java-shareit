...
class BookingMapperTest {
    ...
    void bookingToBookingDtoTest() {
        ...
        BookingDto.ItemDto itemActual = new BookingDto.ItemDto(booking.getItem().getId(), booking.getItem().getName());
        BookingDto.UserDto bookerActual = new BookingDto.UserDto(booking.getBooker().getId(), booking.getBooker().getName());
