...
public class BookingRejectedFetchStrategy implements BookingStateFetchStrategy {
    ...
    public List<Booking> fetchByBooker(Long id, Pageable pageable) {
        return bookingRepository.findAllByBookerIdAndStatus(id, Status.REJECTED, pageable);
    }

    @Override
    public List<Booking> fetchByOwner(Long id, Pageable pageable) {
        return bookingRepository.findAllByItemOwnerIdAndStatus(id, Status.REJECTED, pageable);
    }
}
