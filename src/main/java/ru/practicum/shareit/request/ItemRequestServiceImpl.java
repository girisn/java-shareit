...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    public ItemRequestDto createRequest(Long id, ItemRequestShortDto itemRequestShortDto) {
        ...
        return ItemRequestMapper.itemRequestToRequestDto(itemRequestsRepository.save(itemRequest));
    }
    ...
    public ItemRequestDto getRequestById(Long id, Long requestId) {
        ...
        ItemRequestDto request = ItemRequestMapper.itemRequestToRequestWithItems(itemRequest);
